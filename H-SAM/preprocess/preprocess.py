...
hashmap = {1:1, 2:2, 3:3, 4:4, 5:0, 6:5, 7:6, 8:7, 9:0, 10:8, 11:0, 12:0, 13:0}
...
def preprocess_valid_image(image_files: str, label_files: str) -> None:
    # os.makedirs(f"/data2/wyx/medical/amos22/datava/", exist_ok=True)
    os.makedirs(f"/home/shadeform/H-SAM/testset/amos22/dataVa/", exist_ok=True)
    ...
    for image_file, label_file in pbar:
        # **/imgXXXX.nii.gz -> parse XXXX
        # number = image_file.split('/')[-1][3:7]
        number = image_file.split('.')[0].split('_')[-1]
        ...
        save_path = f"/home/shadeform/H-SAM/testset/amos22/dataVa/amos_{number}.npy.h5"
...
if __name__ == "__main__":
    # data_root = f"/data2/wyx/medical/amos22"
    data_root = f"/home/shadeform/H-SAM/testset/amos22"

    # String sort
    image_files = sorted(glob(f"{data_root}/imagesVa/*.nii.gz"))
    label_files = sorted(glob(f"{data_root}/labelsVa/*.nii.gz"))
