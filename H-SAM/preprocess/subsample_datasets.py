...
if __name__ == '__main__':
    ...
    # parser.add_argument('--root', type=str, default='/data2/zhcheng/train_npz')
    parser.add_argument('--root', type=str, default='/home/shadeform/H-SAM/testset/amos22/dataVa/')
    # parser.add_argument('--output', type=str, default='/data2/zhcheng/train_npz_new')
    parser.add_argument('--output', type=str, default='/home/shadeform/H-SAM/testset/amos22/dataVa_new/')
